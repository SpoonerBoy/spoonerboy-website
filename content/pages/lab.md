...
slug: lab
template: page-lab
custom_excerpt: A self-hosted lab running on Raspberry Pis, UniFi networking, and Docker — zero cloud bills, zero open ports.
---

<!--
  HOW TO USE THIS FILE
  =====================
  The page hero and stat row (2 Pis, 0 ports, etc.) are in page-lab.hbs.
  Edit those numbers directly in the template file.

  Everything below goes into Ghost Admin as HTML cards.
  Paste each section as a separate HTML card block.
-->
...
<div class="sb-section">
  <div class="sb-cards sb-stagger">
    ...
    <a href="/homelab/" class="sb-card sb-card-link">
      ...
      <div class="sb-card-desc">See every service and project running in the lab — with status, guides, and links.</div>
      <div style="margin-top:12px;color:var(--blue);font-size:13px">View projects →</div>
    </a>
    ...
    <a href="https://homelabdocumented.com" class="sb-card sb-card-link" target="_blank" rel="noopener">
      ...
      <div class="sb-card-desc">Full reference site with runbooks, network diagrams, and configs for the entire lab.</div>
